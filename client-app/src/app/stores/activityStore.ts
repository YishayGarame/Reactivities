...
export default class ActivityStore {
    ...
    private getActivity = (id: string) => {
        return this.activityRegistrey.get(id);
    }
        ...
        try {
            ...
            runInAction(() => {
                if (activity.id) {
                    ...
                    this.activityRegistrey.set(activity.id, updatedActivity as Activity);
    ...
    updateAttendance = async () => {
        ...
        try {
            ...
            runInAction(() => {
                ...
                this.activityRegistrey.set(this.selectedActivity!.id, this.selectedActivity!)
            })
        } catch (error) {
            console.log(error);
        } finally {
